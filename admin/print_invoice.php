...
$pdf->Cell($columnWidths[2], 5, '$' . number_format($invoiceData['total_price'] / $invoiceData['quantity'], 2), 1, 0, 'R');
$pdf->Cell($columnWidths[3], 5, '$' . number_format($invoiceData['total_price'], 2), 1, 1, 'R');
